...
try {
    $stmt = $pdo->query("
        SELECT
            ...
            COALESCE(a.nature_of_business, bn.business_nature_name) AS business_nature_name,
            a.service_division_id,
            COALESCE(a.service_category, sd.service_division_name) AS service_division_name,
            a.sub_sector,
            a.business_field,
            a.business_name,
